...
1. Review the **folder (1)** creation and Click on **Approve (2)** to approve the request.
    ...
    >**Note:** Approve all the request generated by co-work.
...
1. In the **Cowork pane**, enter the following **prompt (1)** and click **Send** to submit the governance audit request.
...
1. Review all findings and recommendations before proceeding to the remediation task and execute a Governance Recommendation.
...
1. In the **Message Cowork** box, enter the following value:
    ...
    >**Note**: Select anything of your choice.

1. Type **2 (1)** and click on **Send (2)** button to approve governance action **#2**.

    ![](./media/m5e2t3s1.png)

1. If prompted **select (1)** and specify the governance action you want to proceed with and click on **Submit (2)**.
